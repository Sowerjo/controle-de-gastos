...
export const AppleIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ClearIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PiggyBankIcon: React.FC<IconProps> = ({ className = '', size = 20 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    className={className}
  >
    <path d="M19 5c-1.5 0-2.8 1.4-3 2.8l-1.2-0.4c-2.4-0.8-5.1 0.4-6.4 2.7L7 12.5c-0.6 1.1-0.1 2.5 1 3.1l0.5 0.3c1.1 0.6 2.5 0.1 3.1-1l1.4-2.4c1.3-2.3 4-3.5 6.4-2.7l1.2 0.4c0.2-1.4 1.5-2.8 3-2.8" />
